...
gulp.task('default', ['MAIN_SITE_JAVASCRIPT_MINIFIER', 'MAIN_SITE_HTML_MINIFIER', 'ADMIN_PANEL_JAVASCRIPT_MINIFIER','ADMIN_PANEL_HTML_MINIFIER'], function() {
  ...
  gulp.watch('./Frontend/MainSite/js/dev/**/*.js', function() {
    gulp.run('MAIN_SITE_JAVASCRIPT_MINIFIER');
  });
  gulp.watch('./Frontend/AdminPanel/js/dev/**/*.js', function() {
    gulp.run('ADMIN_PANEL_JAVASCRIPT_MINIFIER');
  });
  //watch the html changes
  gulp.watch('./Frontend/MainSite/html/dev/*.html', function() {
    gulp.run('MAIN_SITE_HTML_MINIFIER');
  });
  gulp.watch('./Frontend/AdminPanel/html/dev/*.html', function() {
    gulp.run('ADMIN_PANEL_HTML_MINIFIER');
  });
